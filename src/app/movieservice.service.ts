...
export class MovieserviceService {
  ...
  getMovies(): Observable<Movie[]> {
    return this.http.get<Movie[]>('https://moviebookingapplication.azurewebsites.net/api/v1.0/moviebooking/GetAllMovies');
  }
  private apiUrl = 'https://moviebookingapplication.azurewebsites.net/api/v1.0/moviebooking';
